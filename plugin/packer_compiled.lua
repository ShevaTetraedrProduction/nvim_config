...
_G.packer_plugins = {
  ...
  indentLine = {
    loaded = true,
    path = "/home/mike/.local/share/nvim/site/pack/packer/start/indentLine",
  ...
  tagbar = {
    loaded = true,
    path = "/home/mike/.local/share/nvim/site/pack/packer/start/tagbar",
  ...
  ["vim-isort"] = {
    loaded = true,
    path = "/home/mike/.local/share/nvim/site/pack/packer/start/vim-isort",
    url = "https://github.com/fisadev/vim-isort"
  },
  ["vim-jinja"] = {
    loaded = true,
    path = "/home/mike/.local/share/nvim/site/pack/packer/start/vim-jinja",
